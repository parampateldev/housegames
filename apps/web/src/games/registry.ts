...
export const GAMES: GameEntry[] = [
  ...
  },
  {
    ...
    minPlayers: 3,
    Component: comingSoon('Imposter'), // TODO(coordinator): rewire once apps/web/src/games/imposter/ lands
  },
  {
    slug: 'mafia',
    label: 'Mafia',
  ...
  },
  {
    ...
    minPlayers: 4,
    Component: comingSoon('Pictionary'),
  },
  {
    slug: 'charades',
    label: 'Charades',
  ...
  },
  {
    ...
    minPlayers: 2,
    Component: comingSoon('Wavelength'),
  },
  {
