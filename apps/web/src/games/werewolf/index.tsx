...
import {
  createWerewolfRoom, joinWerewolfRoom, watchWerewolfRoom, watchMySecret, watchLocalSecrets,
...
function WerewolfApp({ uid, name }: { uid: string; name: string }) {
  ...
  const [localSecrets, setLocalSecrets] = useState<Record<string, WerewolfSecret>>({});
